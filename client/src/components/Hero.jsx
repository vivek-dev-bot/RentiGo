    ...
    return (
        <motion.div
            ...
            <motion.form onSubmit={handleSearch}
                ...
                className='flex flex-col md:flex-row items-start md:item-center justify-between p-6 rounded-full
                        w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,0, 0,1)]'>

                <div className='flex flex-col md:flex-row items-start md-itmes-center gap-10 min-md:ml-8'>
