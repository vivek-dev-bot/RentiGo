        ...
        <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.logo} alt="logo" className='h-12 md:h-14 w-auto object-contain' />
                    <p className='text-sm'>

                        Rentigo is your trusted car rental partner, offering comfortable rides, easy bookings, and affordable prices for every journey.
                    </p>
                ...
                <div>
                    ...
                    <ul className='mt-3 flex flex-col gap-2 text-sm'>
                        ...
                        <li><a href="#">New your , CA</a></li>
                        <li><a href="#">+1 23675464</a></li>
                        <li><a href="#">@INFO@EXMAPLE</a></li>
                    </ul>
                </div>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© 2025 Vivek Chaurasia@All rights reserved.</p>
